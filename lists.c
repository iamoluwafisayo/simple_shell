 ...
 * @head: an address of pointer to- the  head node
 * @str: string field of node
 * @num: the node indexbeen  used by the  history
 *
...
/**
 * print_list_str - this  prints out only the string elements of a list_t linked list
 ...
 * @head: an address of pointer to the first node
 * @index: an index of node to be deleted
 *
 ...
 * @head_ptr: an address of pointer to the head node
 *
 * Return: void()
 */
