 ...
 * @arg: string generated from getline which has arguements
 ...
 * @alias: alias node
 * @env_changed: to be on if environment was changed
...
/**
 * struct builtin - contains built_in string and other related functions
